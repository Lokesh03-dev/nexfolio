    ...
    <Stack sx={{ alignItems: 'flex-start', gap: 3, height: 1, justifyContent: 'center' }}>
      <Stack sx={{ gap: 1 }}>
        <Stack sx={{ alignItems: 'flex-start', gap: 1.5 }}>
          <Chip
            label={<Typography variant="subtitle2">Nexfolio</Typography>}
            icon={
              <CardMedia
                component="img"
          ...
          />
          <Typography variant="h5">Build a portfolio that feels premium from day one</Typography>
        </Stack>
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
          Create a recruiter-ready website from your resume and customize it before you publish.
        </Typography>
      </Stack>
      <Button
        variant="contained"
...
const data = {
  menuItems: [
    ...
    },
    {
      title: 'External',
      itemsList: [
        { title: 'Website', link: { href: 'https://new-design-portfolio-tau.vercel.app/', target: '_blank' } },
        { title: 'Documentation', link: { href: DOCS_URL, target: '_blank' } },
        { title: 'Email', link: { href: 'mailto:abhishekdabas2005@gmail.com', target: '_blank' } },
        { title: 'Instagram', link: { href: 'https://instagram.com/ok.abhishek', target: '_blank' } },
        { title: 'LinkedIn', link: { href: 'https://linkedin.com/in/dabas-abhishek', target: '_blank' } }
      ]
    }
  ],
