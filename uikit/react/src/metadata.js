...
const title = `${branding.brandName} | Resume to Portfolio AI Builder`;
const description = 'Transform resumes into polished portfolio websites with AI. Customize every section, preview live, and deploy your personal brand in minutes.';
...
export const mainMetadata = {
  ...
  keywords: [
    `${branding.brandName}`, 'resume to portfolio', 'AI portfolio builder', 'personal branding', 'portfolio website'
  ],
  creator: `${branding.company.name}`,
  metadataBase: new URL(process.env.NEXT_PUBLIC_METADATA_BASE || branding.company.url || 'http://localhost:3000'),
  alternates: {
    canonical: '/'
  },
  openGraph: {
...
const sectionCommonMeta = {
  ...
  description: `Explore ${branding.brandName}'s collection of portfolio blocks, designed to help you build a complete personal website with hero sections, social proof, contact areas, and conversion-focused layouts.`
};

const aboutPageCommonMeta = {
  title: 'About',
  description: `${branding.brandName} turns resumes into beautiful portfolio websites with AI, helping professionals present their experience, projects, and personal brand with less manual work.`
};

const careerPageCommonMeta = {
  title: 'Career',
  description: `Explore careers and opportunities built around ${branding.brandName}'s AI portfolio experience, from design to development and product growth.`
};

const faqPageCommonMeta = {
  title: 'FAQ',
  description: `Find answers about ${branding.brandName}, including resume upload, AI parsing, templates, customization, deployment, and support.`
};

const pricingPageCommonMeta = {
  title: 'Pricing',
  description: `Discover flexible pricing for ${branding.brandName}, with plans that include AI resume parsing, live editing, source download, and one-click deployment.`
};
...
const privacyPolicyCommonMeta = {
  ...
  description: `${branding.brandName}'s privacy policy explains how resume data, uploads, and account details are handled to protect user privacy and build trust.`
};

const contactUsCommonMeta = {
  title: 'Contact Us',
  description: `${branding.brandName} contact page provides direct ways to reach Abhishek Dabas by email, phone, website, and social profiles.`
};
...
const underMaintenanceCommonMeta = {
  ...
  description: `${branding.brandName} under maintenance page informs users about temporary downtime while keeping the experience clear and professional.`
};
