 ...
 *
 * Demos:
 * - [Footer7](https://new-design-portfolio-tau.vercel.app/blocks/footer/footer7)
 */
...
const data = [
  {
    ...
    menu: [
      ...
      {
        label: 'Blog',
        link: { href: branding.company.url, ...linkProps }
      },
      {
  ...
  },
  {
    ...
    menu: [
      ...
      {
        label: 'Email',
        link: { href: branding.company.socialLink.email, ...linkProps }
      },
      {
        label: 'Instagram',
...
const usefullLinks = [
  {
    icon: <SvgIcon name="tabler-layout-grid" {...iconProps} />,
