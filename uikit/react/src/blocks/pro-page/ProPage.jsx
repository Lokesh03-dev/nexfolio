        ...
        >
          <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <Typography variant="body1" color="textSecondary" sx={{ mb: 3, color: 'grey.700', textAlign: 'center' }}>
              <Link href="https://www.nexfolio.io/" target="_blank" underline="hover" component={NextLink}>
                Check out Nexfolio PRO
              </Link>{' '}
            ...
            <Grid container spacing={2} justifyContent="center">
              <Grid>
                <Button
                  variant="outlined"
                  component={NextLink}
                  href="https://www.figma.com/design/mlkXfeqxUKqIo0GQhPBqPb/Nexfolio---UI-Kit---Preview-only?node-id=11-1833&t=JBHOIIEuYZpmN6v8-1"
                  target="_blank"
                  sx={{ minWidth: 215 }}
              ...
              <Grid>
                <ButtonAnimationWrapper>
                  <Button
                    ...
                    color="primary"
                    component={NextLink}
                    href={'https://www.nexfolio.io/sections'}
                    target="_blank"
